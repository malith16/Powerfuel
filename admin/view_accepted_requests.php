...
<head>
    ...
    <title>ADMIN VIEW CUSTOMER ACCEPTED REQUEST</title>
    <!-- loader-->
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        if(isset($_POST['search'])){
                                            $query1="SELECT * FROM `accepted_request` WHERE station_location LIKE('$_POST[serach_input]%')";
                                            $result1=mysqli_query($connection,$query1);
                                            while($row1=mysqli_fetch_assoc($result1)){
                                                echo "<tr>";
                                                echo "<td>{$row1['user_id']}</td>";
                                                echo "<td>{$row1['user_gmail']}</td>";
                                                echo "<td>{$row1['vehicle_number']}</td>";
                                                echo "<td>{$row1['station_id']}</td>";
                                                echo "<td>{$row1['station_district']}</td>";
                                                echo "<td>{$row1['station_location']}</td>";
                                                echo "<td>{$row1['request_fuel']}</td>";
                                                echo "<td>{$row1['accepted_token']}</td>";
                                                echo "<td>{$row1['accepted_date']}</td>";
                                            ...
                                            $query="SELECT * FROM `accepted_request`";
                                            $result=mysqli_query($connection,$query);
                                            while($row=mysqli_fetch_assoc($result)){
                                               echo "<tr>";
