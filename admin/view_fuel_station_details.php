...
<head>
    ...
    <title>ADMIN FUEL STATION DETAILS</title>
    <!-- loader-->
                                    ...
                                    <?php
                                        if(isset($_POST['search'])){
                                            ...
                                            while($row1=mysqli_fetch_assoc($result1)){
                                                ...
                                                echo "<td>{$row1['fuel_status']}</td>";
                                                echo "<td>{$row1['station_status']}</td>";
                                               
                                                echo "<form action='station_status_update.php' method='post'>";
                                                    echo "<input type='hidden' value='{$row1['station_id']}' name='station_id'>";
    
                                                    if ($row1['station_status'] == 'Activate') {
                                                ...
                                                echo "<td>";
                                                echo "<form action='station_details_update.php' method='post'>";
                                                echo "<input type='hidden' value='{$row1['station_id']}' name='station_id'>";
                                                echo "<button type='submit' class='btn btn-warning'  name='edit' >Edit</button></br></br>";
                                                echo "</form>";
                                                echo "</td>";
                                                echo "<td>";
                                                echo "<form action='station_details_delete.php' method='post'>";
                                                echo "<input type='hidden' value='{$row1['station_id']}' name='station_id'>";
                                                echo "<button type='submit' class='btn btn-danger'  name='delete_details' >Delete</button></br></br>";
                                                echo "</form>";
                                                echo "</td>";
                                                echo "</tr>";
                                            }
                                            ...
                                            while($row=mysqli_fetch_assoc($result)){
                                               ...
                                               echo "<form action='station_details_delete.php' method='post'>";
                                               echo "<input type='hidden' value='{$row['station_id']}' name='station_id'>";
                                               echo "<button type='submit' class='btn btn-danger' value='delete_details' name='delete_details' >Delete</button></br></br>";
                                               echo "</form>";
                                               echo "</td>";
