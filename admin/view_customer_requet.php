                                ...
                                <tbody>
                                    <?php
                                        if(isset($_POST['search'])){
                                            $query1="SELECT * FROM `fuel_request` WHERE request_stationlocation	 LIKE('$_POST[serach_input]%')";
                                            ...
                                            while($row1=mysqli_fetch_assoc($result1)){
                                                ...
                                                echo "<td>{$row1['accept_status']}</td>";
                                               
                                             
                                
                                                echo "<td>";
                                                echo "<form action='fuel_request_accept.php' method='post'>";
                                            ...
                                            $query="SELECT * FROM `fuel_request`";
                                            $result=mysqli_query($connection,$query);
                                            while($row=mysqli_fetch_assoc($result)){
                                               echo "<tr>";
