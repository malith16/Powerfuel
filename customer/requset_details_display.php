...
$query1="SELECT * FROM customer WHERE customer_gmail='$_SESSION[usergmail]'";
...
<head>
    ...
    <title>CUSTOMER VIEW SEND REQUEST</title>
    <!-- loader-->
        ...
        <div class="container-fluid">
            <div class="row align-items-center vh-100">
                <div class="col-12 col-lg-12">
                    <div class="card">
                        <div class="card-title" align='center'>VIEW SEND REQUEST</div>
                            ...
                            <table class="table align-items-center table-flush table-borderless">
                                ...
                                <tbody>
                                    <?php
                                            ...
                                            $query="SELECT * FROM `fuel_request` WHERE request_userid='$_SESSION[customer_id]'";
